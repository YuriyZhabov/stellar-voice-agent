"""Tests for OpenAI LLM client with context management."""
...
class TestTokenUsage:
    ...
    def test_cost_estimate(self):
        ...
        assert abs(usage.cost_estimate - expected_cost) < 0.001
...
class TestOpenAILLMClient:
    ...
    def mock_settings(self):
        ...
        with patch('src.clients.openai_llm.get_settings') as mock:
    ...
    def client(self, mock_settings):
        ...
        with patch('src.clients.openai_llm.AsyncOpenAI'):
    ...
    def test_client_initialization(self, mock_settings):
        ...
        with patch('src.clients.openai_llm.AsyncOpenAI') as mock_openai:
            client = OpenAILLMClient()
    ...
    async def test_generate_response_rate_limit_error(self, client):
        ...
        # Create a mock response object for the RateLimitError
    ...
    @pytest.mark.asyncio
    async def test_generate_response_timeout_error(self, client):
...
class TestIntegration:
    ...
    async def test_full_conversation_flow(self):
        ...
        with patch('src.clients.openai_llm.get_settings') as mock_settings:
